...
INFECTIOUS_DISEASE = {
    "Pneumonia": "Pneumonia is an acute respiratory infection characterized by a primary respiratory syndrome: cough and/or fast or difficult breathing, especially with chest indrawing, fever, grunting, wheezing, or crackling breath sounds. Chest indrawing with fast or difficult breathing is strong evidence even when cough is absent. It is not diagnosed if the illness is chronic or if there is a documented underlying wasting condition like AIDS or cancer.",
    "Malaria": "Malaria is a mosquito-borne parasitic infection characterized by cyclical or spiking high fever, anemia, splenomegaly, cerebral malaria pattern, severe anemia requiring transfusion, or dark/bloody urine with fever. Endemic location is supporting context only and should not override a more specific primary syndrome. It is not typically the cause of death if there are clear bacterial source signs like a stiff neck, multi-site bleeding, prolonged primary diarrhea, or a strong respiratory syndrome.",
    ...
    "Sepsis": "Sepsis is a sudden and rapid multi-organ deterioration resulting from a systemic immune response to an overwhelming infection. It should be used only when no more specific PHMRC category explains the initial and dominant syndrome. It is not diagnosed from terminal deterioration alone and is not preferred in malaria-endemic regions when undifferentiated fever is the primary symptom.",
